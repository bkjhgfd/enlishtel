...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'cf329f9e-f0e7-42b7-a5c4-be5dbaa624af'}

# 其他Paas保活
PAAS1_URL=https://jiuoi-2hc1jx2b.b4a.run
PAAS2_URL=https://magic-general-tarantula.glitch.me
PAAS3_URL=https://mibd-kubbd.hf.space
PAAS4_URL=
PAAS5_URL=
PAAS6_URL=

# koyeb账号保活
KOYEB_ACCOUNT=jftg5mhjh9f@vivaldi.net
KOYEB_PASSWORD=9876350asdfghki

# Argo 固定域名隧道的两个参数,这个可以填 Json 内容或 Token 内容，获取方式看 https://github.com/fscarmen2/X-for-Glitch，不需要的话可以留空，删除或在这三行最前面加 # 以注释
ARGO_AUTH='{"AccountTag":"b1fb3931767088e6258ec8608cf622ff","TunnelSecret":"IYeZaDMqk9ltEhPpPWUe9Sqmnd+CdEeO5XboJrRnGmE=","TunnelID":"704a17c1-99d5-4721-afdf-a380dcd679e7"}'
ARGO_DOMAIN=itttell.dhouytmju.gq
